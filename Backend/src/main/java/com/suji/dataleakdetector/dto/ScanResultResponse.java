...
public class ScanResultResponse {
  ...
  private List<PiiFindingResponse> findings = new ArrayList<>();
  ...
  public List<PiiFindingResponse> getFindings() {
    return findings;
  }

  public void setFindings(List<PiiFindingResponse> findings) {
